...
public:
	...
	// The stock implementation strips the leading '/' from absolute paths
	// (a relic of RmlUi's sample asset roots), which breaks textures loaded
	// from absolute filesystem paths such as the downloaded artwork cache.
